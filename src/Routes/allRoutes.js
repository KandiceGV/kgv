...
// import OPTransactions from '../pages/Transactions/optransactions';
// import Profile from '../pages/Profile/profile';
// import History from '../pages/History/history';


import Login from '../views/BasicSignIn';
import SignUp from '../views/SignUp';


// import Users from '../pages/Starter/Starter';
...
const publicRoutes = [
  ...
  { path: "/home", component: <Home /> },
  { path: "/slotgames", component: <SlotGames /> },
  { path: "/newgames", component: <NewGames /> },
  { path: "/livegames", component: <LiveGames /> },
